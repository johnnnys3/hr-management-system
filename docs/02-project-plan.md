...
- **Stage 9 Deployment does not conclude in this project.** M19's 3 days build and exercise the containerised composition; they do not produce a production deployment. Neither extension changes this: none of ADR-0009's three conditions is a matter of having more time.
