...
| M6 | `docs/09-deployment-plan.md` | 2026-11-05, and constrained | Working day 82; week 17 of §6.3. Schedulable; not completable while TBD-003 is open. See §8.3 |
| M7 | `docs/10-user-guide.md` | 2026-11-09 | Working day 84; week 17 of §6.3 |
...
**M7 now falls on 2026-11-09 — which is the earliest finish of §7.2, and this is not a coincidence.** The user guide is the last deliverable in the allocation, so the date it completes *is* the date the work completes. A reader should take the two figures as one fact stated in two places, not as mutual corroboration. **The 1.5 days between M7 and 2026-11-10 are the whole margin**, and they are the same 1.5 days §6.3 shows unallocated in week 17.
...
**M6's separate constraint is unchanged by any of the three extensions, and by v1.4, which is not one.** It is schedulable, and it still cannot be *completed* while TBD-003 is open, because the decision rule at ADR-0009 requires legal confirmation, registration where applicable, and a target satisfying HRMS-NFR-020, HRMS-NFR-012, and HRMS-NFR-035, none of which a longer schedule supplies. The 2026-11-05 date is when `docs/09-deployment-plan.md` is written to that decision rule with TBD-003 recorded as open. It is not when a hosting target is selected. Section 8.3 explains.
...
The window runs 2026-07-15 to 2026-11-10: 17 weeks, 85 working days, against the 83.5 required by §7.3.
...
| 7 | 2026-09-01 | M4 factor recovery and administration prohibition (1d of 4); M5 Employee Management (4d) |
| 8 | 2026-09-08 | M6 Departments (1d); M7 Reporting Structure (1.5d); M8 Recruitment (2.5d of 4) |
...
| 15 | 2026-10-27 | M17 Reports (0.5d of 3); M18 Testing (4d); M19 UAT (0.5d of 3) |
| 16 | 2026-11-03 | M19 UAT (2.5d of 3); M20 Deployment (2.5d of 3) |
| 17 | 2026-11-10 | M20 Deployment (0.5d of 3); `docs/09-deployment-plan.md` (1.5d); `docs/10-user-guide.md` (1.5d); **1.5d unallocated** |
...
| M5 Employee Management | 4 | 12 FRs, document upload, audit history. **Unchanged at v1.3, v1.4, and v1.5.** HRMS-FR-010's audit history is a filtered read of M1's store, not a second store; there was no separable audit line here to move to module 1. See §6.1 |
| M6 Departments | 1 | |
...
| M16 Payroll | 8 | 14 FRs; PAYE, SSNIT Tier 1, Tier 2, Tier 3; versioned rate tables; atomic finalisation; idempotent Celery tasks; payslips; bank transfer file |
| M17 Reports | 3 | |
| M18 Testing | 4 | Hardening beyond per-module tests |
| M19 UAT | 3 | |
| M20 Deployment | 3 | |
| `docs/09-deployment-plan.md` | 1.5 | |
| `docs/10-user-guide.md` | 1.5 | Nine guides at SRS §2.6, less the optional training videos |
| **Total** | **83.5** | Of which 62.5 was the v1.0 baseline, 5.5 is the §2.4 coverage gap closed at v1.1, 10 is HRMS-NFR-024 at v1.2, 3 is the audit module at v1.3, and 2.5 is the notification split at v1.4 — 4 days for M2 and M11 against the 1.5 they replace |

### 7.2 The Arithmetic

The window is 2026-07-15 to 2026-11-10. On the convention pinned at §6.2: **17 weeks at 5 working days for one person = 85 working days.** Against the 83.5 required by §7.3:

- Available: **85 working days**.
- Required: **83.5 working days**.
- Margin: **1.5 working days**, approximately 1.8% of the required effort.
- Ratio: **0.982 times the available capacity.**

83.5 working days from 2026-07-15, at five days a week with no slippage, complete halfway through working day 84 — **2026-11-09**, a Monday, under §6.2. The end date remains 2026-11-10 because it is working day 85 and closes week 17, which is the rule that set 2026-11-03 over 2026-10-30 at v1.2 and 2026-11-10 over 2026-11-04 at v1.3. The day and a half between is the margin above and is the 1.5 days shown unallocated at §6.3. No figure in this section and no date at §5.2 is derived by any route other than §6.2's rule.
...
| TBD-009 | Document retention policy | **Open. Not resolvable by this project** | `docs/09-deployment-plan.md`; audit log retention per `docs/07-iam-rbac.md` §7.3; M5 document storage per ADR-0007 | Before Stage 9 |
