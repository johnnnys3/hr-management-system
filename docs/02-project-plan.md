...
|---|---|---|
| Single point of failure in resourcing | Any absence stops the project entirely. There is no second person and no partial capacity | Not mitigable by planning. Recorded as an accepted condition of a solo project. It compounds every estimate in §7.1. The 4 days of margin at §7.2 absorb about four days of absence across 17 weeks before the date moves, but §7.4 is the reading that governs: the margin is where 81 happens to fall between two multiples of five, not provision anyone made against absence |
