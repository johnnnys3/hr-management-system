...
| John Kessie | 2026-07-27 | **Recruiter retired, merged into HR Administrator** (SRS v1.5, ADR-0013 amending ADR-0010). Module 8 (Recruitment) and Module 9 (Onboarding)'s visibility-rule cells rename Recruiter to HR Administrator; Module 5 (Departments)'s cell drops Recruiter from its HR/Payroll read list, already covered by "All HR". No dependency, audit-emission, or notification-emission cell changes | 1.5 |
...
| 5 | Departments | — | Configuration changes | — | HR Administrator: create/update. All HR/Payroll: read |
...
| 8 | Recruitment | Module 6 (conversion target), Module 7 (approving manager, if any) | Requisition and offer decisions | Consumes neither Module 2 nor Module 10 (ADR-0011 rationale — no SRS requirement names a recruitment notification) | HR Administrator: full (absorbed from Recruiter, retired — ADR-0013). HR Officer: read. Others: none |
| 9 | Onboarding | Module 8 (candidate conversion), Module 6 (employee record created) | Onboarding task completion | Sends via Module 2 (email-only; ADR-0011 §"Why the surface sits at 11") | HR Officer: create/read/update. HR Administrator: read |
